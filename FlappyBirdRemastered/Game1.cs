...
using FlappyBirdRemastered.Desktop.Classes;

namespace FlappyBirdRemastered.Desktop
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            Console.WriteLine(gameController.GameState);
            ...
            switch (gameController.GameState)
            {
                case GameController.INIT_STATE:
                    ...
                    if (mouseState.LeftButton == ButtonState.Released && Mouse.GetState().LeftButton == ButtonState.Pressed)
                    {
                        ...
                        gameController.GameState = GameController.SELECT_BOOSTER_STATE; // TODO GameController.GETTING_GIFT_STATE; // TODO GameController.PLAYING_STATE;
                    }
                    mouseState = Mouse.GetState();
                    break;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.DrawString(textFont, "TUS PRIMEROS PUNTOS NO VALEN", new Vector2((graphics.PreferredBackBufferWidth / 2) - (textFont.MeasureString("TUS PRIMEROS PUNTOS NO VALEN").X / 2), 80), Color.White);
            }
